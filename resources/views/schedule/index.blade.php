@extends('layouts.v1')
@section('title') Data Tanggal @endsection
@section('content')
  ...
  <div class="content">
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-md-12">
                <a href="{{route('schedule.create')}}" class="btn btn-primary">Tambah Tanggal</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
...
<script>
                        ...
                        },
                        {
                                    ...
                                    render: function(value, param, data) {
                                        return '<div class="btn-group">' +
                                            '<a class="btn btn-sm btn-primary" href="/admin/schedule/' + value +
   ...
   function deleteConfirm(id) {
            swal({
                    title: "Kamu Yakin ?",
                    text: "akan menghapus Schedule ini !",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((dt) => {
                    if (dt) {
                        window.location.href = "{{ url('admin/schedule') }}/" + id + "/delete";
                    }
                });
        }
  </script>
