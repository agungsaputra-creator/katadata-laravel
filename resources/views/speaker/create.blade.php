@extends('layouts.v1')
@section("title") Tambah Speaker @endsection
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('speaker.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    <label for="nama_kategori">Posisi / Jabatan</label>
                                    <input type="text" name="jabatan"
                                        class="form-control  @error('name') is-invalid @enderror"
                                        placeholder="Jabatan / Posisi" value="{{ old('jabatan') }}">
                                    @error('jabatan')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="nama_kategori">Photo</label>
